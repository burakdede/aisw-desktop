...
export const toolStatusSchema = z.object({
  ...
  claude_auth_classification: z.string().nullable().optional(),
  codex_auth_classification: z.string().nullable().optional(),
  antigravity_auth_classification: z.string().nullable().optional(),
...
export type ProjectBindingsReport = z.infer<typeof projectBindingsReportSchema>;
